...
public class Driver extends Thread{
    ...
    /*
        ...
        Chrome became the most reliable driver during the move from
        Selenium v2 to v3 and when Firefox when through the v47 - 48 upgrades

        I made Chrome the default.
    ...
    public static WebDriver get() {
        ...
        if(useThisDriver == null){
            ...
            if("SAFARI".contentEquals(defaultBrowser))
        ...
        if(aDriver==null){
            ...
            switch (useThisDriver) {
                ...
                case SAUCELABS:
                    ...
                    // prior to version 4 the desired capabilities had defaults
                    //DesiredCapabilities firefoxCapabilities = DesiredCapabilities.firefox();
                    // with version 4 the defaults have been deprecated so we create them ourselves
                    DesiredCapabilities firefoxCapabilities = new DesiredCapabilities("firefox", "", Platform.ANY);
