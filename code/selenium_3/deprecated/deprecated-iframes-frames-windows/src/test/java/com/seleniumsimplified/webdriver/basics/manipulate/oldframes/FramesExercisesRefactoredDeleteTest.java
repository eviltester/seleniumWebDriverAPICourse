...
public class FramesExercisesRefactoredDeleteTest {
    ...
    public void workWithTheIFrame(){
        ...
        driver.switchTo().frame("content");
        final By selector = By.cssSelector("a[href='index.html']");
        // needed to wait until clicking
        wait.until(ExpectedConditions.elementToBeClickable(selector));
        driver.findElement(selector).click();

        // Deprecated final step
        // need to wait prior to switching context
//        wait.until(ExpectedConditions.urlContains("/frames/index.html")) ;
//        driver.switchTo().defaultContent();
