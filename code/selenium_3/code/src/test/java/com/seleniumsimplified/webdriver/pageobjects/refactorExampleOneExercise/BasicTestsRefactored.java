package com.seleniumsimplified.webdriver.pageobjects.refactorExampleOneExercise;
...
public class BasicTestsRefactored {
    ...
    public void chooseToCodeInJavascriptOnTheWeb(){
        ...
        // selecting server, causes the Web selection to trigger an XHTTP request
        // so the page uses the server values and the
        // values from the server are correct.
        // The values in the initial HTML are incorrect. e.g. JavaScript is set to 1, rather than 0
        basicAjaxPage.selectCategory(Category.SERVER);
